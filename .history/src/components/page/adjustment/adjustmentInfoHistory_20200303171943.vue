<template>
    ...
    <!-- <div style="margin:10px 0"> -->
      ...
      <el-form :inline="true" :model="params" class="demo-form-inline" label-width="120px">
        <el-form-item label="车架号">
          <el-input class="inputSelectClass"  v-model="params.frameNumber" placeholder="请填写" size="small"></el-input>
        </el-form-item>
        ...
        <el-form-item label="调出经销商">
          <el-input class="inputSelectClass"  v-model="params.outAgentName" placeholder="请填写" size="small"></el-input>
        </el-form-item>
        <el-form-item label="调入经销商">
          <el-input class="inputSelectClass"  v-model="params.inAgentName" placeholder="请填写" size="small"></el-input>
        </el-form-item>
          <el-form-item>
 ...
 >
      ...
      <el-table-column prop="cityName" label="上牌地" width="100" :show-overflow-tooltip='true' resizable></el-table-column>
      <el-table-column prop="factoryMatchesModel" label="主机厂匹配车型" width="250" :show-overflow-tooltip='true' resizable></el-table-column>
      <el-table-column prop="createTime" label="调剂时间" width="200" :show-overflow-tooltip='true' resizable></el-table-column>
      <el-table-column prop="contractValidTime" label="合同生效时间" width="150" :show-overflow-tooltip='true' resizable></el-table-column>
      <el-table-column prop="adjustStatuView" label="调剂状态" width="150" :show-overflow-tooltip='true' resizable></el-table-column>
