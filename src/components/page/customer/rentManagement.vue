<template>
  <div>
      ...
      <div>
        <el-form :inline="true" :model="params" class="demo-form-inline" label-width="130px">
            <el-form-item label="所属地区">
                <el-select class="inputSelectClass" v-model="params.areaCode" placeholder="所属地区" size="small" clearable>
            ...
            <el-input class="inputSelectClass" v-model="params.licenceName" placeholder="牌照商" size="small"></el-input>
            </el-form-item>
            ...
            <el-input class="inputSelectClass" v-model="params.lessor" placeholder="出租方" size="small"></el-input>
            </el-form-item>
    ...
    'color': '#fff',
      ...
      <el-table-column fixed type="index" label="序号" :index="indexMethod" resizable width="80" align="center"></el-table-column>
      <el-table-column fixed prop="licenceCode" label="牌照商代码" width="100"  :show-overflow-tooltip='true'  resizable></el-table-column>
      <el-table-column fixed prop="licenceName" label="牌照商名称" width="250"  :show-overflow-tooltip='true'  resizable></el-table-column>
      <el-table-column prop="lessor" label="出租方" width="250"  :show-overflow-tooltip='true'  resizable></el-table-column>
      <el-table-column prop="socialCreditCode" label="社会统一信用代码" width="150"  :show-overflow-tooltip='true'  resizable></el-table-column>
      <el-table-column fixed prop="isLimitLicence" label="是否限牌" width="100"  :show-overflow-tooltip='true'  resizable></el-table-column>
      <el-table-column fixed prop="isGalcCompany" label="租赁公司" width="100" :show-overflow-tooltip='true'  resizable></el-table-column>
      <el-table-column prop="legalRepresentative" label="法定代表人" width="100"  :show-overflow-tooltip='true'  resizable></el-table-column>
      <el-table-column prop="legalTelephone" label="法定代表人联系电话" width="250"  :show-overflow-tooltip='true'  resizable></el-table-column>
      <el-table-column prop="contactPerson" label="联系人" width="100"  :show-overflow-tooltip='true'  resizable></el-table-column>
      <el-table-column prop="contactPersonTelephone" label="联系人联系电话" width="150"  :show-overflow-tooltip='true'  resizable></el-table-column>
      <el-table-column prop="bankAccountNo" label="开户银行账号" width="150"  :show-overflow-tooltip='true'  resizable></el-table-column>
      <el-table-column prop="bankAccountName" label="开户银行名称" width="150"  :show-overflow-tooltip='true'  resizable></el-table-column>
      <el-table-column prop="billingAddress" label="开票地址" width="200"  :show-overflow-tooltip='true'  resizable></el-table-column>
      ...
      <el-table-column  prop="areaName" label="地区" width="100"  :show-overflow-tooltip='true'  resizable></el-table-column>
      ...
      <el-table-column  prop="registerAddress" label="注册地址" width="150"  :show-overflow-tooltip='true'  resizable></el-table-column>
