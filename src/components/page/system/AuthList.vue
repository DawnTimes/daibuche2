  ...
  <div class="main">
    <div class="userPage">
      ...
      <el-row type="flex" class="row-bg fr" justify="end">
        <el-button icon="el-icon-plus" type="primary" plain round @click="adduser" v-show="rolePermission.roleAdd">新增</el-button>
      </el-row>      
    </div>
    <el-table :data="tableData" style="width: 100%" stripe :height="GLOBAL.height" border :header-cell-style="{
    'text-align':'center',
    'font-weight':'bold',  
    'background':'#627CAF',    
    'color': '#fff',
      ...
      <el-table-column fixed="right" label="操作" width="300" resizable>
        ...
        <el-button size="mini" @click="setAuth(scope.row)" v-show="rolePermission.assignPermission">权限设定</el-button>
        <el-button size="mini" type="danger" @click="del(scope.row)" v-show="rolePermission.roleDelete">删除</el-button>
        </template>
      </el-table-column>
    </el-table>
    <el-pagination
