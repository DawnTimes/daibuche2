<template>
  <div class="main">
    <div>
      <el-form :inline="true" :model="params" class="demo-form-inline" label-width="120px">
        <el-form-item label="经销商简称">
          <el-input class="inputSelectClass" v-model="params.agentShortName" placeholder="请填写" size="small"></el-input>
        </el-form-item>
        <el-form-item label="牌照商名称">
          <el-input class="inputSelectClass" v-model="params.licenceName" placeholder="请填写" size="small"></el-input>
        </el-form-item>
        <el-form-item label="租赁方式">
          <el-select class="inputSelectClass" v-model="params.leaseWay" placeholder="请选择租赁方式" clearable size="small">
        ...
        <el-form-item label="限牌与否">
          <el-select class="inputSelectClass" v-model="params.isLimitLicence" placeholder="请选择" clearable size="small">
            <el-option label="是" value="Y"></el-option>
            <el-option label="否" value="N"></el-option>
          </el-select>          
        </el-form-item>        
        <el-form-item label="管理编号">
          <el-input class="inputSelectClass" v-model="params.manageNumber" placeholder="请填写" size="small"></el-input>
        </el-form-item>
        <el-form-item label="上牌地">
          <el-input class="inputSelectClass" v-model="params.cityName" placeholder="请填写" size="small"></el-input>
        </el-form-item>
        <el-form-item label="合同编号">
          <el-input class="inputSelectClass" v-model="params.contractNumber" placeholder="请填写" size="small"></el-input>
        </el-form-item>
        <el-form-item label="合同审核状态">
          <el-select class="inputSelectClass" v-model="params.contractFlowStatus" placeholder="请选择" clearable size="small">
        ...
        <el-form-item label="是否已寄合同">
          <el-select class="inputSelectClass" v-model="params.isSend" placeholder="请选择" clearable size="small">
            <el-option label="是" value="Y"></el-option>
            <el-option label="否" value="N"></el-option>
          </el-select>
        </el-form-item>
    ...
    <el-table :data="tableData" style=" margin-top:10px" stripe border :header-cell-style="{
    'text-align':'center',
    'font-weight':'bold',  
    'background':'#627CAF',    
    'color': '#fff',
 ...
 :height="GLOBAL.height">
      ...
      <el-table-column prop="contractNumber" label="合同编号" width="200" fixed :show-overflow-tooltip='true' resizable>
      ...
      <el-table-column prop="cityName" label="上牌地" width="150" :show-overflow-tooltip='true' resizable></el-table-column>
      <el-table-column prop="agentShortName" label="经销商简称" width="150" :show-overflow-tooltip='true' resizable></el-table-column>
      <el-table-column prop="agentCode" label="经销商代码" width="150" :show-overflow-tooltip='true' resizable></el-table-column>
      <el-table-column prop="agentFullName" label="经销商名称" width="250" :show-overflow-tooltip='true' resizable></el-table-column>
      <el-table-column prop="licenceName" label="牌照商名称" width="250" :show-overflow-tooltip='true' resizable></el-table-column>
      ...
      <el-table-column prop="leaseWay" label="租赁方式" width="100" :show-overflow-tooltip='true' resizable></el-table-column>
      <el-table-column prop="carCount" label="台数" width="100" :show-overflow-tooltip='true' resizable align="right"></el-table-column>
      ...
      <el-table-column prop="isLimitLicence" label="限牌与否" width="100" :show-overflow-tooltip='true' resizable></el-table-column>
      <el-table-column prop="contractFlowStatus" label="合同审核状态" width="150" :show-overflow-tooltip='true' resizable></el-table-column>
      <el-table-column prop="isSend" label="是否已寄合同" width="120" :show-overflow-tooltip='true' resizable></el-table-column>
      <el-table-column prop="contractPath" label="合同下载" width="150" :show-overflow-tooltip='true' resizable>
         <template slot-scope="scope">
          ...
          <el-button size="mini" @click="downLoad(scope.row.contractPath)" type="text" v-if="scope.row.contractPath">点击下载</el-button>
...
/*       let flag = common.checkRolePermission2(165,this.$store.state.asideInfoIds);
    ...
    handleOperation(index, row, name) {
        this.$emit('handleOperation', {contractNumber: row.contractNumber, flag:name})
    },      
    indexMethod(index) {
