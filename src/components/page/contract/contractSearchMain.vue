...
<script>
import contractSearch from '@/components/page/contract/contractSearch'
import viewTheRepaymentPlan from '@/components/page/contract/viewTheRepaymentPlan'
import viewApprovalProcess from '@/components/page/contract/viewApprovalProcess'
  ...
  mounted(){
    ...
    methods: {
      ...
      handleOperation(data) {
        ...
        if(flag) {
            let newTabName = data.flag === 'viewApprovalProcess'? '查看审批记录':'查看还款计划'
