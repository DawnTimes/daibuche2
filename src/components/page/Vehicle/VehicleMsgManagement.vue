<template>
  <div>
    ...
    'color': '#fff',
      ...
      <el-table-column fixed prop="frameNumber" label="车辆识别代号/车架号码" width="170"  :show-overflow-tooltip='true'  resizable></el-table-column>
      <el-table-column prop="engineNumber" label="发动机号码"  width="100"  :show-overflow-tooltip='true'  resizable></el-table-column>
      <el-table-column prop="batch" label="批次"  :show-overflow-tooltip='true'  resizable ></el-table-column>
      <el-table-column prop="batchExpiryDate" label="批次到期日" width="100" :show-overflow-tooltip='true'  resizable></el-table-column>
      <el-table-column prop="batchStartingDate" label="批次起租日" width="100" :show-overflow-tooltip='true'  resizable></el-table-column>
      ...
      <el-table-column prop="monthlyRent" label="月租金" :show-overflow-tooltip='true'  resizable align="right"></el-table-column>
      <el-table-column prop="rentCardFee" label="租牌费"  :show-overflow-tooltip='true'  resizable align="right"></el-table-column>
      <el-table-column prop="carBrand" label="品牌"  width="200" :show-overflow-tooltip='true'  resizable></el-table-column>
      <el-table-column prop="carSeries" label="车系" width="100"  :show-overflow-tooltip='true'  resizable></el-table-column>
      ...
      <el-table-column prop="finalPayment" label="尾款"  :show-overflow-tooltip='true'  resizable align="right"></el-table-column>
      <el-table-column prop="carUseView" label="车用途类型" width="100"  :show-overflow-tooltip='true'  resizable></el-table-column>
      <el-table-column prop="agentCode" label="店代码" width="100" :show-overflow-tooltip='true'  resizable></el-table-column>
      <el-table-column prop="agentFullName" label="经销商名称（承租方）" width="250"  :show-overflow-tooltip='true'  resizable></el-table-column>
      ...
      <el-table-column prop="insuranceCompany" label="保险承保公司" width="110"  :show-overflow-tooltip='true'  resizable></el-table-column>
      <el-table-column prop="insuranceNo" label="商业险保单号"  width="110"  :show-overflow-tooltip='true'  resizable></el-table-column>
      <el-table-column prop="insuranceEndDate" label="商业险到期日"  width="110"  :show-overflow-tooltip='true'  resizable></el-table-column>
      ...
      <el-table-column fixed="right" label="操作" width="50">
        <template slot-scope="scope">
          <el-button @click="handleClick(scope.row)" type="text" size="small" v-show= 'rolePermission.editCar'>编辑</el-button>
        </template>
      </el-table-column>
    </el-table>
    <el-pagination
...
export default {
  ...
  methods: {
    ...
    exportExcel() {
      ...
      window.location.href = `/api/carmanage-admin/excel/exportCars?agentCode=${this.sonData.agentCode?this.sonData.agentCode:""}&atmt=${this.sonData.atmt?this.sonData.atmt:""}&batch=${this.sonData.batch?this.sonData.batch:""}&carUse=${this.sonData.carUse?this.sonData.carUse:""}&engineNumber=${this.sonData.engineNumber?this.sonData.engineNumber:""}&factoryMatchesModel=${this.sonData.factoryMatchesModel?this.sonData.factoryMatchesModel:""}&frameNumber=${this.sonData.frameNumber?this.sonData.frameNumber:""}&isLimitLicence=${this.sonData.isLimitLicence?this.sonData.isLimitLicence:""}&monthlyRent=${this.sonData.monthlyRent?this.sonData.monthlyRent:""}&msrp=${this.sonData.msrp?this.sonData.msrp:""}&plateNumber=${this.sonData.plateNumber?this.sonData.plateNumber:""}`
        ...
        axios.post(searchUrl, data).then(res => {
          if (res.em === 'Success!') {
            ...
            this.tableData.forEach((obj,index) => {
              ...
              if (obj.compulsoryInsuranceEndDate) obj.compulsoryInsuranceEndDate = obj.compulsoryInsuranceEndDate.substr(0, 10);                
              if (obj.batchStartingDate) obj.batchStartingDate = obj.batchStartingDate.substr(0, 10);                
              if (obj.batchExpiryDate) obj.batchExpiryDate = obj.batchExpiryDate.substr(0, 10);                
              if (obj.insuranceEndDate) obj.insuranceEndDate = obj.insuranceEndDate.substr(0, 10); 
              if (obj.rentState) {
    ...
    handleSizeChange(pageSize) {
      ...
      this.searchParams.turnPageShowNum = pageSize
       if(this.msgType=="search"){
        this.searchParams.turnPageBeginPos = ((this.currentPage-1) * this.pageSize) + 1
    ...
    handleCurrentChange(currentPage) {
      ...
      if(this.msgType=="search"){
        this.searchParams.turnPageBeginPos = ((currentPage-1) * this.pageSize) + 1
        this.searchParams.turnPageShowNum = this.params.turnPageShowNum
        this.getCarInfo(this.searchParams)
      }else{
        this.getCarInfo(this.params)
