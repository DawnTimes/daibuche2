      ...
      <div>
        <el-row type="flex" class="row-bg" justify="end">
          ...
          <el-button
            ...
            round
            @click="doAdjust"
            v-show="rolePermission.PreAdjust"
          >预调剂</el-button>
          <el-button
            icon="el-icon-search"
            type="primary"
            ...
            round
            @click="cancelAdjust"
            v-show="rolePermission.cancelAdjust"
          >调剂取消</el-button>
        </el-row>
      </div>
    </div>
            ...
            <el-row>
              <div class="grid-content bg-purple-light">
                <el-form-item class="grid-content bg-purple-light" label="牌照商">
                  <el-select
                    v-model="licenceNameViewForSearch"
                    placeholder="请选择牌照商"
                    multiple
                    style="width:91%"
  ...
  methods: {
    ...
    onSubmit() {
      ...
      for (var i = this.params.licenceCode.length - 1; i >= 0; i--) {
        if (!this.params.licenceCode[i]) this.params.licenceCode.splice(i, 1);
      }
      if (this.params) {
        if (
          this.params.agentCode.length == 0 &&
          this.params.licenceCode.length == 0
        ) {
