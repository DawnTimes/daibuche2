    ...
    <div class="userPage">
      ...
      <el-row type="flex" class="row-bg" justify="end" style="margin-bottom:10px">
        <el-button
          ...
          round
          @click="addInfo"
          v-show="rolePermission.agentAdd"
        >新增</el-button>
      ...
      <el-table-column fixed="right" label="操作" width="80">
        <template slot-scope="scope">
          <el-button
            ...
            size="small"
            v-show="rolePermission.agentEdit"
          >编辑</el-button>
        </template>
      </el-table-column>
            ...
            <el-row>
              ...
              <el-col :span="24">
                <div class="grid-content bg-purple">
                  ...
                  >
                    <el-select v-model="divParams.taxPayerType" style="width:100%" clearable>
                      <!-- AT--自动/MT--手动 -->
              ...
              <el-col :span="24">
                <div class="grid-content bg-purple">
                  ...
                  >
                    <el-select v-model="divParams.status" style="width:100%" clearable>
                      <!-- AT--自动/MT--手动 -->
                      <el-option label="有效" value="Y"></el-option>
                      <el-option label="无效" value="N"></el-option>
                    </el-select>
            ...
            <el-row>
              ...
              <el-col :span="24">
                <div class="grid-content bg-purple">
                  ...
                  >
                    <el-select v-model="divEditParams.taxPayerType" style="width:100%" clearable>
                      <!-- AT--自动/MT--手动 -->
                      <el-option label="一般纳税人" value="0"></el-option>
                      <el-option label="小规模纳税人" value="1"></el-option>
                      <el-option label="个人" value="2"></el-option>
              ...
              <el-col :span="24">
                <div class="grid-content bg-purple">
                  ...
                  >
                    <el-select v-model="divEditParams.status" style="width:100%" clearable>
                      <!-- AT--自动/MT--手动 -->
                      <el-option label="有效" value="Y"></el-option>
                      <el-option label="无效" value="N"></el-option>
                    </el-select>
              ...
              <el-col :span="24">
                <div class="grid-content bg-purple">
                  ...
                  >
                    <el-select
                      v-model="divEditParams.areaCode"
                      placeholder="所属地区"
                      style="width:100%"
                      @change="areaEditChange"
                    >
                      <el-option label="台湾" value="007"></el-option>
                      <el-option label="华北" value="003"></el-option>
                      <el-option label="华中" value="006"></el-option>
              ...
              <el-col :span="24">
                <div class="grid-content bg-purple-light">
                  ...
                  >
                    <el-select
                      v-model="divEditParams.cityCode"
                      style="width:100%"
                      @change="selectDisposeCode"
                    >
                      <el-option
...
export default {
  ...
  methods: {
    ...
    provinceChange() {
      ...
      axios
        .post(url, { provinceCode: this.divParams.provinceCode })
        .then((res) => {
          if (res.em === 'Success!') {
    ...
    provinceEditChange() {
      ...
      let url = common.findCityInfoUrl;
      axios
        .post(url, { provinceCode: this.divEditParams.provinceCode })
        .then((res) => {
          if (res.em === 'Success!') {
            this.cityList = res.data.cityList;
          }
