        ...
        <div class="grid-content bg-purple-light">
          <el-form-item class="page-form-item" label="品牌、车系：" prop="carBrand">
            <el-select
              ...
              placeholder="请选择所属品牌"
              @change="carBrandChanged"
              class="mselect"
            >
              <el-option
                v-for="item in carseris"
                :key="item.carBrandName"
                :label="item.carBrandName"
                :value="item.carBrandName"
              ></el-option>
            </el-select>
            <el-select
              v-model="form.carSeries"
              placeholder="请选择所属车系"
              @change="carSeriesChanged"
              class="mselect"
            >
              <el-option
