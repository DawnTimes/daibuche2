...
export default {
  ...
  methods: {
    initData() {
      ...
      axios
        .post(url, { contractNumber: this.dataParams.contractNumber })
        .then((res) => {
          if (res.em === 'Success!') {
  ...
  mounted() {
    setTimeout(function () {
      let height = document.getElementsByClassName('el-table__fixed')[1].style
        .height;
      height = height.replace('px', '');
      height = parseInt(height); // 234
      height = height - 10 + 'px';
      let height2 = document.getElementsByClassName('el-table__fixed')[2].style
        .height;
      ...
      document.getElementsByClassName(
        'el-table__fixed'
      )[1].style.height = height;
      document.getElementsByClassName(
        'el-table__fixed'
      )[2].style.height = height2;
    }, 1000);
  },
};
</script>
