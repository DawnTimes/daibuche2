  ...
  methods: {
    ...
    handleOperation(index, row, name) {
      this.$emit('handleOperation', {
        ...
        flag: name,
        contractFlowStatus: row.contractFlowStatus,
      });
    },
    indexMethod(index) {
    ...
    initData() {
      ...
      common.checkConstractFlow(
        162,
        this.$store.state.asideInfoIds,
        '1',
        this.params.contractFlowStatus
      );
      common.checkConstractFlow(
        163,
        this.$store.state.asideInfoIds,
    ...
    initData2() {
      ...
      common.checkConstractFlow(
        ...
        this.$store.state.asideInfoIds,
        '1',
        this.realParams.contractFlowStatus
      );
      common.checkConstractFlow(
        163,
        this.$store.state.asideInfoIds,
