 ...
 * @LastEditTime: 2020-08-10 15:27:57
 * @LastEditors: your name
 * @Description: 
 * @FilePath: \webcode2\src\views\contract\viewApprovalProcess.vue
-->
<template>
  <div>
    ...
    <div class="taskDetail" v-for="(item, index) in tableData" :key="index">
      <div class="item">
        <label>合同编号</label>
        ...
        .then((res) => {
          if (res.em === 'Success!') {
            ...
            this.tableData.forEach((obj, index) => {
              if (obj.approvalTime)
                obj.approvalTime = obj.approvalTime.substr(0, 10);
